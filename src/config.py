"""
AI Paper Catchup Agent の設定ファイル
"""
...
class Settings(BaseSettings):
    ...
    github_repo: str = os.getenv("GITHUB_REPOSITORY", "Yagami360/ai-paper-catchup-agent")
    ...
    news_count_report: int = int(os.getenv("NEWS_COUNT_REPORT", "10"))
