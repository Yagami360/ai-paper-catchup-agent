"""
AI Paper Catchup Agent メインアプリケーション
"""
...
from .agent import AIPaperCatchupAgent
...
def main() -> None:
    """メイン関数"""
    logger.info("Started AI Paper Catchup Agent")
    logger.debug(f"settings: {settings}")

    parser = argparse.ArgumentParser(
        description="AI Paper Catchup Agent - 最新AI技術動向レポート生成ツール",
